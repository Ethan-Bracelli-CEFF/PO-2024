...
<html lang="en">
    ...
    <body>
        ...
        <main>
            <div style="display: flex; justify-content: center; margin-top: 7%"><img src="qrCode.png" alt="Qr code" style="height: 700px" onclick='window.location.href = "http://morpion/PO-2024/accueil.php"'></div>
        </main>
        <footer>
